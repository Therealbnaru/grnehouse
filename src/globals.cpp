...
pros::Motor intake(-13, pros::v5::MotorGears::green); // Motor is a reversed green motor on port 4
pros::Motor hood(15, pros::v5::MotorGears::blue); // Motor is a normal blue motor on port 16
